      ...
      <table width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" >
          <tr>
            <td>
            	...
            	Create new Job Post &nbsp;&nbsp; [ Fields marked with(<font color="#FF0000">*</font>)must be entered ]</td>
            	</tr>
            	...
            	<td align="center" >
                    ...
                    <input name="company" type="text" class="content" size="25" value=""/>
                    </tr>
                  ...
                  <!--  <tr>
                    ...
                    <input name="email" type="text" class="content" value="" size="25" 
					...
					<td height="25" align="left" valign="middle">
                    <input name="url" type="text" class="content" size="25" value="" />
                    </tr>
         -->           
                    <tr>
                    <td height="25" align="left" valign="top" nowrap="nowrap" class="subcontent">
                    ...
                    <td height="25" align="left" valign="middle">
                    <input name="title" type="text" class="content" size="25" value="" /></td>
                    </tr>
                    ...
                    <td height="25" align="left" valign="middle">
                    <input name="location" type="text" class="content" value="" size="25" /></td>
                    </tr>
                    ...
                    <td height="25" align="left" valign="middle">
                    <textarea name="description" class="content" cols="35" rows="5" ></textarea>
                    </td></tr>
                    ...
                    <td height="25" align="left" valign="middle">
                    <textarea name="to_apply" class="content" cols="35" rows="3"></textarea>
                    </td></tr>
                    ...
                    <input name="sub_addjob_detail" type="submit" class="buttonSubmit" onClick="return validation();" value="Submit" />
                    ...
                    <tr>
                    <td height="5" colspan="2" align="center" valign="middle" ></td></tr>
                    </table>
				</td></tr>
