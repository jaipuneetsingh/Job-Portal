...
<div class="infoform">
    <div class="main">
        <h2>Personal Detail</h2><h4 align="right"><a href='edit_per_detail.php'>Edit Personal Detail</a></h4><hr /><br />
        ...
        <div class="left">&nbsp;</div>
        <div class="right">&nbsp;</div>
        <h2>Educational Detail</h2><h4 align="right"><a href='edit_edu_detail.php'>Edit Educational Detail</a></h4><hr /><br />
        ...
        <div class="left">&nbsp;</div>
        <div class="right">&nbsp;</div>
        <h2>Career Detail</h2><h4 align="right"><a href='edit_career_detail.php'>Edit Career Detail</a></h4><hr /><br />
